...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { order_detail_id: @detail.order_detail_id, price: @detail.price, product_id: @detail.product_id, quantity: @detail.quantity } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { order_detail_id: @detail.order_detail_id, price: @detail.price, product_id: @detail.product_id, quantity: @detail.quantity } }
