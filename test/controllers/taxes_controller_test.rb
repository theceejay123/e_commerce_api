...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { name: @tax.name, province_id: @tax.province_id, tax: @tax.tax } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { name: @tax.name, province_id: @tax.province_id, tax: @tax.tax } }
